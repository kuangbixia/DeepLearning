...
- 产生**不对齐**问题——**<u>量化</u>**带来了RoI和提取的特征**不对齐**的结果，**使得包围盒和回归时得到的位置出现偏差**，对像素到像素的**mask预测**有很大的负面影响
  ...
  <img src="E:/DeepLearning/Figures/Mask R-CNN/misalignment.png"  />
...
- **接上图例子**：
  ...
  ![](E:/DeepLearning/Figures/Mask R-CNN/RoIAlign.png)
...
- 其他：
  ...
  <img src="E:/DeepLearning/Figures/Mask R-CNN/ResNet-C4.JPG" style="zoom:67%;" />

  - 提出使用**ResNet-FPN**（Feature Pyramid Network），应用在Mask R-CNN中提取特征会有很大的提高

  <img src="E:/DeepLearning/Figures/Mask R-CNN/ResNet-FPN.JPG" style="zoom:67%;" />
