...
2. 三种方法
   ...
   2. 结合CRF和DCNN：在DCNN的最高层的特征图（有多个/nClass个通道的belief map）后增加几个额外的卷积层，来捕获上下文信息
   3. 学习一个全局的稀疏的高维卷积，并结合高斯CRF和DCNN

### 3 Spatial Pyramid Pooling 空间金字塔池化



### 4 Atrous Convolution 空洞卷积
